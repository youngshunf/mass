var pubApp = angular.module('mass', [])
...
.controller('cityListCtrl', function($scope) {
	...
	_.each($scope.cityList,function(item){
		item.char=item.pinyin.substr(0,1);
	});
	
    $scope.selectItem=function(item){
    	  localStorage.setItem('currentCity',item.name);
    	  var index=plus.webview.getWebviewById('pages/home/index.html');
			mui.fire(index,'show',null);	
			mui.back();
    }
});